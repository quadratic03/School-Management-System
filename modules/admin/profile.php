 ...
 * Admin Profile
 * 
 * This file manages the admin profile view and edit functionality
 */
...
$userProfile = getUserProfile($currentUser['id'], 'admin');

// If profile doesn't exist, create a basic one
if (!$userProfile) {
    $sql = "INSERT INTO admin_profiles (user_id, first_name, last_name) VALUES (?, ?, ?)";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    if (empty($firstName) || empty($lastName)) {
        ...
        try {
            ...
            $sql = "UPDATE admin_profiles SET first_name = ?, last_name = ?, phone = ?, address = ? WHERE user_id = ?";
            executeNonQuery($sql, [$firstName, $lastName, $phone, $address, $currentUser['id']]);
            ...
            if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
                ...
                if (in_array($_FILES['profile_image']['type'], $allowedTypes)) {
                    if (move_uploaded_file($_FILES['profile_image']['tmp_name'], $uploadFile)) {
                        ...
                        $sql = "UPDATE admin_profiles SET profile_image = ? WHERE user_id = ?";
            ...
            // Log activity
            logActivity($currentUser['id'], 'Updated profile information', 'Admin profile update');
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-center text-muted mb-0">Administrator</p>
            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="3"><?php echo htmlspecialchars($userProfile['address'] ?? ''); ?></textarea>
                    </div>
