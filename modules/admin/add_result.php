 ...
 * Add Exam Result
 * 
 * This file handles adding exam results for students
 */

$pageTitle = "Add Exam Result";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($marksObtained < 0 || $marksObtained > $exam['max_marks']) {
        ...
        try {
            ...
            $sql = "INSERT INTO exam_submissions (exam_id, student_id, marks_obtained, remarks) 
                    VALUES (?, ?, ?, ?)";
            $params = [$examId, $studentId, $marksObtained, $remarks];
            executeQuery($sql, $params);
            
            // Log activity
            logActivity($currentUser['id'], "Added exam result for student {$student['first_name']} {$student['last_name']}");
            ...
            rollbackTransaction();
            $error = "Error adding exam result: " . $e->getMessage();
        }
    }
}
?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Add Exam Result</h5>
                    <div>
